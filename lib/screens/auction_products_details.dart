...
class _AuctionProductsDetailsState extends State<AuctionProductsDetails>
  ...
  var _auctionproductDetails = null;
                      ...
                      child: Center(
                        child: Text(
                          (_auctionproductDetails.highestBid == '' ||
                              ...
                              ? AppLocalizations.of(context)
                                  .auction_product_details_screen_place_bid
                              : AppLocalizations.of(context)
                                  .auction_product_details_screen_change_bid,
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 16,
                              fontWeight: FontWeight.w600),
      ...
      children: [
        Padding(
          ...
          child: Container(
            ...
            child: Text(
              AppLocalizations.of(context)
                  .auction_product_details_screen_starting_bid,
      ...
      children: [
        Padding(
          ...
          child: Container(
            ...
            child: Text(
              AppLocalizations.of(context)
                  .auction_product_details_screen_highest_bid,
              style: TextStyle(color: Color.fromRGBO(153, 153, 153, 1)),
            ),
          ),
        ),
      ...
      children: [
        Padding(
          ...
          child: Container(
            ...
            child: Text(
              AppLocalizations.of(context)
                  .auction_product_details_screen_auction_end,
              style: TextStyle(color: Color.fromRGBO(153, 153, 153, 1)),
            ),
          ),
        ),
          ...
          child: Container(
            ...
            child: CountdownTimer(
              ...
              endTime: DateTime.now().day +
                  1000 * _auctionproductDetails.auctionEndDate,
