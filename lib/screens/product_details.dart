...
print("single price ${variantResponse.price}");
    ...
    return Row(
      children: [
        Text(
          ...
          _singlePriceString.replaceAll(SystemConfig.systemCurrency.code, SystemConfig.systemCurrency.symbol)
              :_singlePriceString,
         // _singlePriceString,
          style: TextStyle(
              color: MyTheme.accent_color,
        ...
        Visibility(
          ...
          child: Padding(
            ...
            child: Text(
                ...
                SystemConfig.systemCurrency !=null?
    _productDetails.stroked_price.replaceAll(SystemConfig.systemCurrency.code, SystemConfig.systemCurrency.symbol)
