...
Future  fetchShopData() async {
 ...
 return fetchShopData();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(LangText(context).local.followed_seller_screen_title,style: MyStyle.appBarStyle,),backgroundColor: MyTheme.white,
          ...
          children: <Widget>[
              ...
              onTap: (){
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) {
                      return SellerDetails(id:sellerInfo.shopId ,);
                    }));
              },
              child: Container(
                  ...
                  child: ClipRRect(
                      ...
                      child: FadeInImage.assetNetwork(
                        ...
                        imageErrorBuilder: (BuildContext errorContext, Object obj, StackTrace st){
            ...
            Padding(
              ...
              child: Container(
                ...
                child: RatingBar(
                    ignoreGestures: true,
                    initialRating: sellerInfo.shopRating.toDouble(),
                    maxRating: 5,
            ...
            InkWell(
              ...
              child: Container(
                child: Padding(
                  ...
                  child: Text(
                    LangText(context).local.common_unfollow,
                    textAlign: TextAlign.left,
                    overflow: TextOverflow.ellipsis,
                    maxLines: 2,
                    style: TextStyle(
